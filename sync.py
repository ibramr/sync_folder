...
Usage: python sync.py --source [path to source folder] --replica [path to replica folder, if not given, new one will be created] --log [path to logging file] --interval [synchronization interval, default is 5 seconds]
'''
